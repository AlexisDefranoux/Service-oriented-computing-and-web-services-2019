...
namespace CurrencyConverter.Currency {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="Currency.ConverterSoap")]
    public interface ConverterSoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        CurrencyConverter.Currency.ConvertDataTableColumnResponse ConvertDataTableColumn(CurrencyConverter.Currency.ConvertDataTableColumnRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ConvertDataTableColumn", ReplyAction="*")]
        System.Threading.Tasks.Task<CurrencyConverter.Currency.ConvertDataTableColumnResponse> ConvertDataTableColumnAsync(CurrencyConverter.Currency.ConvertDataTableColumnRequest request);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ConverterSoapChannel : CurrencyConverter.Currency.ConverterSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ConverterSoapClient : System.ServiceModel.ClientBase<CurrencyConverter.Currency.ConverterSoap>, CurrencyConverter.Currency.ConverterSoap {
        ...
        CurrencyConverter.Currency.ConvertDataTableColumnResponse CurrencyConverter.Currency.ConverterSoap.ConvertDataTableColumn(CurrencyConverter.Currency.ConvertDataTableColumnRequest request) {
        ...
        public void ConvertDataTableColumn(ref System.Data.DataSet ds, int TableIndex, string ColumnName, string FromCurrency, string ToCurrency) {
            CurrencyConverter.Currency.ConvertDataTableColumnRequest inValue = new CurrencyConverter.Currency.ConvertDataTableColumnRequest();
            inValue.ds = ds;
            inValue.TableIndex = TableIndex;
            inValue.ColumnName = ColumnName;
            inValue.FromCurrency = FromCurrency;
            inValue.ToCurrency = ToCurrency;
            CurrencyConverter.Currency.ConvertDataTableColumnResponse retVal = ((CurrencyConverter.Currency.ConverterSoap)(this)).ConvertDataTableColumn(inValue);
            ds = retVal.ds;
        }
        
        public System.Threading.Tasks.Task<CurrencyConverter.Currency.ConvertDataTableColumnResponse> ConvertDataTableColumnAsync(CurrencyConverter.Currency.ConvertDataTableColumnRequest request) {
